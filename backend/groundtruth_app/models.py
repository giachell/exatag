...
class Concept(models.Model):
    ...
    json_concept = models.TextField(blank=True, null=True)  # This field type is a guess.
...
class Associate(models.Model):
    ...
    class Meta:
        #managed = False
        db_table = 'associate'
        unique_together = (('id_report', 'language','username', 'seq_number', 'label'),)
...
class Contains(models.Model):
    insertion_time = models.TimeField(blank=True, null=True)
    concept_url = models.OneToOneField(Concept, models.DO_NOTHING, db_column='concept_url', primary_key=True)
    ...
    class Meta:
        #managed = False
        db_table = 'contains'
        unique_together = (('concept_url', 'id_report','language', 'username', 'name'),)
...
class Annotate(models.Model):
    ...
    class Meta:
        #managed = False
        db_table = 'annotate'
        unique_together = (('username', 'start', 'stop', 'id_report','language'),)
...
class GroundTruthLogFile(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('insertion_time', 'id_report','language', 'username'),)
...
class Linked(models.Model):
    ...
    class Meta:
        #managed = False
        db_table = 'linked'
        unique_together = (( 'name', 'username', 'concept_url', 'start', 'stop', 'id_report','language'),)
