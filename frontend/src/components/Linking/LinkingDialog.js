...
class DraggableModalDialog extends React.Component {
    render() {
        return <Draggable handle=".modal-dialog"><ModalDialog {...this.props} /></Draggable>
    }
}

function LinkingDialog(props){
    ...
    return(
        ...
        <div>
            <div><h5><span>New Association for: </span><span style={{'color':'royalblue'}}>{props.mention.mention_text}</span></h5></div>
                    <div>
